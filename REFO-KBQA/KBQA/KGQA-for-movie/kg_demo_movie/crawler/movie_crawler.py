...
api_key = '949919ff571a16cb26fbb04763bd89a4'
...
mysql_db = pymysql.connect(host=u'192.168.0.224', use_unicode=True,port=3306,user=u'root',passwd=u'Root@2018',db=u'kg_demo_movie',charset=u'utf8')
